					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalFrutas"><img class="fas" src="imagens/insumos.png" alt="">Frutas</button>
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalPolpas"><img class="fas" src="imagens/barrels64.png" alt="">Polpas</button>
