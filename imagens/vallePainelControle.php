<?php
    ...
    // MARACUJA
    $sql = "SELECT IFNULL(SUM(pesodespolpa), 0) AS totalmaracuja FROM insumos  WHERE producao = 'N' AND fruta = 'MARACUJÁ'";
    $result  = mysqli_query($conectar,$sql);
    if (result == NULL){
        $peso_maracuja = 0;
    } else {
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <div class="modal-body" id="info_dados">
                                                    <form method="post" id="view-dados">
                                                        ...
                                                        <h5 class="modal-title">Data de Fabricação: <span id="data"></span></h5>
...
<script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ["Maracujá", <?php echo $pesopolpa_maracuja ; ?>]
    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          ["Maracujá", <?php echo $peso_maracuja ; ?>]
        ]);
