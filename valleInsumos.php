...
<body>
	<div class="wrapper">
		...
		<div class="main">
			...
			<div class="content">
				...
				<button class="btn btn-info" data-toggle="modal" data-target="#listInsumos">Relatório Insumos</button>
							...
							<div class="col-12 col-sm-6 col-md-6 col-lg-3 mt-3">
								<div class="card h-100 mb-4">                    
									...
									<div class="card-body text-left">
										...
										<p class="card-text">Fruta: <?php echo $linhas['fruta'] ?></p>
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header bg-light">
								<h5 class="modal-title">Cadastro de Insumos</h5>
							...
							<div class="modal-body row" style="text-align: center;">
								<div class="col-6">
									<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modalFrutas">
										<div>Frutas</div>
										<img class="fas" src="imagens/insumos.png" alt="">									 
									</button>
								</div>
								<div class="col-6">
									<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modalPolpas">
										<div>Polpas</div>
										<img class="fas" src="imagens/barrel.png" alt="">									 
									</button>
								</div>
							</div>
				...
				<!-- MODADL LISTA PEDIDO -->
				<div class="modal fade" id="listInsumos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">							
                                        ...
                                        <form action="InsumosPDF.php" method="post"  target="_blank">

                                        FORNECEDOR
										<div class="form-check">
											<input class="form-check-input" type="radio" name="radioBox1" value="todos" checked  onclick="checkRadio(this.value)">
											<label class="form-check-label" for="flexRadioDefault1">
												Todos
											</label>
											</div>
											<div class="form-check">
											<input class="form-check-input" type="radio" name="radioBox1" value="forn" onclick="checkRadio(this.value)">
											<label class="form-check-label" for="flexRadioDefault2">
												Por Fornecedor
											</label>
											<input type="hidden" id="radio1">
										</div>
										<br/>
                                        <div class="row">
                                            <div class="col-12">
                                                <?php
                                                // $ped = 5;
                                                    $resultado = mysqli_query($conectar, "SELECT * FROM fornecedor ORDER BY fornecedor ASC");
                                                    $linhas = mysqli_num_rows($resultado);
                                                    $ordem = 0;
                                                ?>                 
                                                ...
                                                <select class="form-control" id="sel-fornecedor" name="sel-fornecedor" disabled>
												...
												<input type="hidden" name="radio2">
                                            </div>
                                        </div>
										<br/>
										PERÍODO
										<div class="form-check">
											<input class="form-check-input" type="radio" name="radioBox2" value="todos" checked onclick="checkRadio2(this.value)">
											<label class="form-check-label" for="flexRadioDefault1">
												Todos
											</label>
											</div>
											<div class="form-check">
											<input class="form-check-input" type="radio" name="radioBox2" value="periodo" onclick="checkRadio2(this.value)">
											<label class="form-check-label" for="flexRadioDefault2">
												Por Período
											</label>
										</div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="date"  value="<?php echo date("Y-m-d"); ?>" class="form-control" id="datainicio" name="datainicio" disabled>
												<input type="hidden" name="check2">
											</div> 

                                            <div class="col-6">
                                                <label for="datapedido">Até:</label>
                                                <input type="date"  value="<?php echo date("Y-m-d"); ?>" class="form-control" id="datafinal" name="datafinal"  disabled>
                                            </div> 
                                        </div>

										<input type="hidden" id="radio2">

                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                            <button type="submit" id="testeCH" class="btn btn-primary" ><i class='fas fa-print'></i></button>
					...
					<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header  bg-secondary text-light">
								<h5 class="modal-title" id="exampleModalLabel">Entrada de Frutas</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
							</div>
				...
				<div class="modal fade" id="modalPolpas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header  bg-secondary text-light">
								<h5 class="modal-title" id="exampleModalLabel">Entrada de Polpas</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
							</div>
							<div class="modal-body alert-info">
								...
								<form action="valleCadInsumos.php" method="post">
									...
									<div class="row">
										<div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
											<label for="entradapolpa">Data Chegada</label>
											<input type="date" class="form-control" id="entradapolpa" name="entradapolpa" value="<?php echo date('Y-m-d'); ?>"
											 aria-describedby="emailHelp">
										</div>
									...
									<div class="row">
										...
										<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
											...
											<select class="form-control" id="fornecedor-polpa">
									...
									<div class="row">
										...
										<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
											...
											<select class="form-control" id="select-polpa">
                                                ...
                                                <?php $resultado = mysqli_query($conectar, "SELECT * FROM frutas ORDER BY fruta ASC");
                                                while($row1 = mysqli_fetch_array($resultado)):; ?>
                                                    <option value="<?php echo $row1['produto']; ?>"><?php echo $row1["fruta"]; ?></option>
                                                <?php endwhile; ?>                                  
										...
										<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<label for="peso">Peso Liquido (Kg)</label>
											<input type="number" class="form-control" id="pesoTambor" onchange="funCalcT(this.value)">
										</div>

										<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
											<label for="caixas">Qtd Tambor (Unid)</label>
											<input type="number" class="form-control" id="tambor">
										</div>
							...
							<div class="modal-footer alert-info">
								<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
								<button type="button" id="salvarPolpa" class="btn btn-primary">Salvar</button>
							</div>
						</div>
						</form>
					</div>
								...
								<div class="modal-content">
									...
									<div class="modal-body" id="info_dados">
										...
										<h5 class="font-texto">
											...
											<p><span class="span-left">Tipo.:</span> <span class="span-right" id="tipo"></span></p>
	...
	function funCalcT(val){
		var peso = document.getElementById("pesoTambor").value
		var tottambor = peso/200
		document.getElementById("tambor").value = parseFloat(tottambor)
	}
...
<script>
	...
	function checkRadio(radioBox1) {
		document.getElementById("radio1").value = radioBox1
		if(document.getElementById("radio1").value == "todos"){
			document.getElementById("sel-fornecedor").disabled = true
		} else {
			document.getElementById("sel-fornecedor").disabled = false
		}
	}

	function checkRadio2(radioBox2) {
		document.getElementById("radio2").value = radioBox2
		if(document.getElementById("radio2").value == "todos"){
...
<script>
	$(document).ready(function() {
		...
		// SALVAR POLPA INSUMO
		$("#salvarPolpa").click(function() {

			var id = "<?php echo $novo_id; ?>"
			var fornecedor = document.getElementById("fornecedor-polpa").options[document.getElementById(
				"fornecedor-polpa").selectedIndex].text
			var tipo = "Polpa"
			var fruta = document.getElementById("select-polpa").options[document.getElementById("select-polpa").selectedIndex].text
			var produto = document.getElementById("select-polpa").value
			var dataentrada = document.getElementById("entradapolpa").value
			var pesoliquido = document.getElementById("pesoTambor").value
			var tambor = document.getElementById("tambor").value
			var pesodespolpa = document.getElementById("pesoTambor").value
			var observacao = document.getElementById("obs").value

			//var usu = "<?php echo '$usuario'; ?>"

			$.ajax({
				url: "valleCadInsumos2.php",
				type: "post",
				//data:$("#insert").serialize(),
				data: 'entradapolpa=' + dataentrada +
					'&fornecedor=' + fornecedor +
					'&tipo=' + tipo +
					'&fruta=' + fruta +
					'&produto=' + produto +
	...
	$(document).ready(function() {
		...
		$("#testeCH").click(function() {
			var chh = document.getElementById("radioBox1").value
			alert("TESTANDO..."+chh)
		})
